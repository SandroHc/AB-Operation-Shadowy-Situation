...
public class MMD4MecanimBulletPhysics : MonoBehaviour
{
	...
	public class MMDModel
	{
		...
		int[]									_fullBodyIKParentBoneIDList = null;
		...
		Matrix4x4[]								_updateFullBodyIKTransformList = null;
		...
		public int[]		fullBodyIKParentBoneIDList		{ get { return _fullBodyIKParentBoneIDList; } }
		...
		public Matrix4x4[]	updateFullBodyIKTransformList	{ get { return _updateFullBodyIKTransformList; } }
		...
		public bool Create( MMD4MecanimModel model )
		{
			...
			if( mmdModelPtr != IntPtr.Zero ) {
				...
				_UploadMesh( model, meshFlags );
				{
					var gch_fullBodyIKParentBoneIDList		= MMD4MecanimCommon.MakeGCHValues( _fullBodyIKParentBoneIDList );
		...
		void _PrepareWork( MMD4MecanimModel model )
		{
			...
			_fullBodyIKParentBoneIDList				= new int[FullBodyIKTargetMax];
			...
			for( int i = 0; i != FullBodyIKTargetMax; ++i ) {
				_fullBodyIKParentBoneIDList[i] = -1;
			...
			_updateFullBodyIKTransformList			= new Matrix4x4[FullBodyIKTargetMax];
			_updateFullBodyIKWeightList				= new float[FullBodyIKTargetMax];
			for( int i = 0; i != FullBodyIKTargetMax; ++i ) {
				_updateFullBodyIKTransformList[i]	= Matrix4x4.identity;
