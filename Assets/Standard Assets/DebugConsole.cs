		...
		if(visible == false) {
			...
			if(guis.Count < maxMessages) {
				...
				while(x < messages.Count) {
					...
					case "normal":	gui.guiText.material.color = normal;	break;
					case "warning":	gui.guiText.material.color = warning;	break;
					case "error":	gui.guiText.material.color = error;		break;
					}
